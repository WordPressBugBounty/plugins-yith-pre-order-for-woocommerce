 ...
 * @var YITH_Pre_Order_New_Pre_Order_Email $email The WC_Email object.
 */
...
$product_table = wc_get_template_html(
	...
	array(
		...
		'_order'   => $_order,
		'item_id'  => $item_id,
		'context'  => 'new-pre-order',
	),
	'',
	YITH_WCPO_TEMPLATE_PATH
);

do_action( 'ywpo_new_pre_order_email_before_body', $email, $body, $_product, $_order, $item_id, $product_table );

echo wp_kses_post(
	apply_filters(
		'ywpo_new_pre_order_email_body',
...
do_action( 'ywpo_new_pre_order_email_after_body', $email, $body, $_product, $_order, $item_id, $product_table );
