...
if ( ! class_exists( 'YITH_Pre_Order_Product' ) ) {
	...
	class YITH_Pre_Order_Product {
		...
		public function get_pre_order_status() {
			$pre_order_status = $this->product->get_meta( '_ywpo_preorder' );
		...
		public function get_pre_order_mode() {
			$pre_order_mode = $this->product->get_meta( '_ywpo_pre_order_mode' );
		...
		public function get_override_pre_order_mode() {
			$pre_order_mode = $this->product->get_meta( '_ywpo_override_pre_order_mode' );
		...
		public function get_start_mode() {
			$start_mode = $this->product->get_meta( '_ywpo_start_mode' );
		...
		public function get_start_date() {
			$timestamp  = $this->product->get_meta( '_ywpo_start_date' );
		...
		public function get_start_date_timestamp() {
			$start_date = $this->product->get_meta( '_ywpo_start_date' );
			return apply_filters( 'yith_ywpo_pre_order_get_start_date', $start_date, $this->id, $this->product );
		}
		...
		public function get_start_date_label() {
			$start_date_label = $this->product->get_meta( '_ywpo_start_date_label' );
		...
		public function get_availability_date_mode() {
			$availability_date_mode = $this->product->get_meta( '_ywpo_availability_date_mode' );
		...
		public function get_for_sale_date() {
			$timestamp     = $this->product->get_meta( '_ywpo_for_sale_date' );
		...
		public function get_price_mode() {
			$price_mode = $this->product->get_meta( '_ywpo_price_mode' );
		...
		public function get_max_qty_enabled() {
			$max_qty_enabled = $this->product->get_meta( '_ywpo_max_qty_enabled' );
		...
		public function get_override_labels() {
			$override_labels = $this->product->get_meta( '_ywpo_override_labels' );
		...
		public function get_pre_order_label() {
			$pre_order_label = $this->product->get_meta( '_ywpo_preorder_label' );
		...
		public function get_pre_order_availability_date_label() {
			$pre_order_availability_date_label = $this->product->get_meta( '_ywpo_preorder_availability_date_label' );
		...
		public function get_pre_order_no_date_label() {
			$pre_order_no_date_label = $this->product->get_meta( '_ywpo_preorder_no_date_label' );
		...
		public function get_override_fee() {
			$override_fee = $this->product->get_meta( '_ywpo_override_fee' );
		...
		public function get_fee() {
			$fee = $this->product->get_meta( '_ywpo_fee' );
		...
		public function get_override_charge_type() {
			$override_charge_type = $this->product->get_meta( '_ywpo_override_charge_type' );
		...
		public function get_charge_type() {
			$charge_type = $this->product->get_meta( '_ywpo_charge_type' );
		...
		public function get_pre_order_price() {
			$pre_order_price = $this->product->get_meta( '_ywpo_preorder_price' );
		...
		public function get_discount_percentage() {
			$discount_percentage = $this->product->get_meta( '_ywpo_preorder_discount_percentage' );
		...
		public function get_discount_fixed() {
			$discount_fixed = $this->product->get_meta( '_ywpo_preorder_discount_fixed' );
		...
		public function get_increase_percentage() {
			$increase_percentage = $this->product->get_meta( '_ywpo_preorder_increase_percentage' );
		...
		public function get_increase_fixed() {
			$increase_fixed = $this->product->get_meta( '_ywpo_preorder_increase_fixed' );
		...
		public function get_pre_order_adjustment_amount() {
			$price_adjustment_amount = $this->product->get_meta( '_ywpo_price_adjustment_amount' );
		...
		public function get_pre_order_price_adjustment() {
			$price_adjustment = $this->product->get_meta( '_ywpo_price_adjustment' );
		...
		public function get_pre_order_adjustment_type() {
			$adjustment_type = $this->product->get_meta( '_ywpo_adjustment_type' );
		...
		public function set_pre_order_status( $status ) {
			...
			$this->product->update_meta_data( '_ywpo_preorder', $status );
		...
		public function set_pre_order_mode( $mode ) {
			$this->product->update_meta_data( '_ywpo_pre_order_mode', $mode );
		...
		public function set_override_pre_order_mode( $mode ) {
			$this->product->update_meta_data( '_ywpo_override_pre_order_mode', $mode );
		...
		public function set_start_mode( $start_mode ) {
			$this->product->update_meta_data( '_ywpo_start_mode', $start_mode );
		...
		public function set_start_date( $start_date ) {
			if ( ! empty( $start_date ) ) {
				...
				$this->product->update_meta_data( '_ywpo_start_date', $formatted_date ? strtotime( $formatted_date ) : '' );
				do_action( 'yith_ywpo_start_date_changed', $this->product, $start_date );
			} else {
				$this->product->update_meta_data( '_ywpo_start_date', '' );
			}
			$this->product->save();
		}
		...
		public function set_start_date_label( $start_date_label ) {
			$this->product->update_meta_data( '_ywpo_start_date_label', $start_date_label );
		...
		public function set_availability_date_mode( $availability_date_mode ) {
			$this->product->update_meta_data( '_ywpo_availability_date_mode', $availability_date_mode );
		...
		public function set_for_sale_date( $date ) {
			if ( ! empty( $date ) ) {
				...
				$this->product->update_meta_data( '_ywpo_for_sale_date', $format_date ? strtotime( $format_date ) : '' );
				do_action( 'yith_ywpo_pre_order_date_changed', $this->id, $date );
			} else {
				$this->product->update_meta_data( '_ywpo_for_sale_date', '' );
			}
			$this->product->save();
		}
		...
		public function set_dynamic_availability_date( $dynamic_availability_date ) {
			$this->product->update_meta_data( '_ywpo_dynamic_availability_date', $dynamic_availability_date );
		...
		public function set_price_mode( $price_mode ) {
			$this->product->update_meta_data( '_ywpo_price_mode', $price_mode );
		...
		public function set_max_qty_enabled( $max_qty_enabled ) {
			$this->product->update_meta_data( '_ywpo_max_qty_enabled', $max_qty_enabled );
		...
		public function set_max_qty( $max_qty ) {
			$this->product->update_meta_data( '_ywpo_max_qty', $max_qty );
		...
		public function set_override_labels( $override_labels ) {
			$this->product->update_meta_data( '_ywpo_override_labels', $override_labels );
		...
		public function set_pre_order_label( $pre_order_label ) {
			if ( isset( $pre_order_label ) ) {
				$this->product->update_meta_data( '_ywpo_preorder_label', $pre_order_label );
		...
		public function set_pre_order_availability_date_label( $pre_order_availability_date_label ) {
			$this->product->update_meta_data( '_ywpo_preorder_availability_date_label', $pre_order_availability_date_label );
		...
		public function set_pre_order_no_date_label( $pre_order_no_date_label ) {
			$this->product->update_meta_data( '_ywpo_preorder_no_date_label', $pre_order_no_date_label );
		...
		public function set_override_fee( $override_fee ) {
			$this->product->update_meta_data( '_ywpo_override_fee', $override_fee );
		...
		public function set_fee( $fee ) {
			$this->product->update_meta_data( '_ywpo_fee', $fee );
		...
		public function set_override_charge_type( $override_charge_type ) {
			$this->product->update_meta_data( '_ywpo_override_charge_type', $override_charge_type );
		...
		public function set_charge_type( $charge_type ) {
			$this->product->update_meta_data( '_ywpo_charge_type', $charge_type );
		...
		public function set_pre_order_price( $pre_order_price ) {
			$this->product->update_meta_data( '_ywpo_preorder_price', $pre_order_price );
		...
		public function set_discount_percentage( $discount_percentage ) {
			$this->product->update_meta_data( '_ywpo_preorder_discount_percentage', $discount_percentage );
		...
		public function set_discount_fixed( $discount_fixed ) {
			$this->product->update_meta_data( '_ywpo_preorder_discount_fixed', $discount_fixed );
		...
		public function set_increase_percentage( $increase_percentage ) {
			$this->product->update_meta_data( '_ywpo_preorder_increase_percentage', $increase_percentage );
		...
		public function set_increase_fixed( $increase_fixed ) {
			$this->product->update_meta_data( '_ywpo_preorder_increase_fixed', $increase_fixed );
